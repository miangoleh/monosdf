...
python -m torch.distributed.launch --nproc_per_node 1 --nnodes=1 --node_rank=0 training/exp_runner.py --conf confs/studio_mlp.conf  --scan_id 1 --is_continue --timestamp 2024_02_01_13_35_10
